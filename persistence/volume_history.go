...
SELECT `,
    ...
    toUInt256(sumIf(`, UsdInField, `, dex = 'StonfiV1' OR dex = 'StonfiV2') + sumIf(`, UsdOutField, `, dex = 'StonfiV1' OR dex = 'StonfiV2')) AS stonfi_volume_usd,
    toUInt256(sumIf(`, UsdInField, `, dex = 'DeDust') + sumIf(`, UsdOutField, `, dex = 'DeDust')) AS dedust_volume_usd,
    count() AS number
