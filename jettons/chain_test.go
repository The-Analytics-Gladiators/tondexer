...
func TestNovaToken(t *testing.T) {
	tokenDefinition, _ := TokenDefinitionByWallet("EQCudjvsLIf37Tzw7xdZjr_kEYziTJE5hKVDQIeLkbCLamn3")
...
func TestUsdToken(t *testing.T) {
	tokenDefinition, e := TokenDefinitionByWallet("EQCI2sZ8zq25yub6rHEY8FwPqV3zbCqS5oasOdljENCjh0bs")
	if e != nil {
		panic(e)
	}
...
func TestJmnt(t *testing.T) {
	...
	tokenDefinition, e := TokenDefinitionByWallet("EQC1cHQGpDX9tji9VZbRcPue_0J-q4HmMlyldYDCIQNU8_JS")
	if e != nil {
		panic(e)
	}
...
func TestOffChainToken(t *testing.T) {
	tokenDefinition, e := TokenDefinitionByWallet("EQARULUYsmJq1RiZ-YiH-IJLcAZUVkVff-KBPwEmmaQGH6aC")
	if e != nil {
		panic(e)
	}
...
func TestOffChainTokenWithOtherTypesInJson(t *testing.T) {
	tokenDefinition, e := TokenDefinitionByWallet("EQBeQi4AixFN8r8-m3Sm3hHOZYCPQP0vl34RLoayeP0GkVm_")
	if e != nil {
		panic(e)
	}
...
func TestGrimReaper(t *testing.T) {
	tokenDefinition, e := TokenDefinitionByWallet("EQC2BKK8-VtvrWVw2EvVZ4ncd-hz7b_HMWEuBy_Nz9aZ7Qpq")
	if e != nil {
		panic(e)
	}
...
//
//	for _, a := range all {
//		if tokenDefinition, e := TokenDefinitionByWallet(a); e == nil {
